...
## DOCUMENTACION https://www.mercadopago.com.pe/developers/es/reference/test_user/_users_test/post

class MercadoPago:
    def __init__(self):
        self.main_token = os.getenv("MERCADOPAGO_MAIN_ACCES_TOKEN")
        self.child_token = os.getenv("MERCADOPAGO_CHILD_ACCES_TOKEN")
        self.main_headers = {
